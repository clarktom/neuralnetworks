...
w2, b2 = init_weights(10, 10), init_bias(10) #weights and biases from hidden layer to hidden layer
w3, b3 = init_weights(10, 6, logistic=False), init_bias(6) #weights and biases from hidden to output layer
